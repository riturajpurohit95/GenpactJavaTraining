...
public class ProductDaoImpl implements ProductDao {
		...
		@Override
		    public int save(Product product) {    	
		    	 ...
		    	 String sql = "INSERT INTO products (product_id,user_id,category_id,product_name,product_price,product_mrp,product_quantity,product_avg_rating,product_reviews_count) " +
		                "VALUES (?, ?, ?, ?, ?,?,?,?)";
	 ...
	 //find by category id
			...
			public int update(Product product){
				String sql= "Update products set user_id = ?,category_id = ?,product_name = ?,product_price = ?,product_mrp = ?,product_quantity = ?,product_avg_rating = ?,product_reviews_count= ?  where product_id = ?) "+
	                  "VALUES (?, ?, ?, ?, ?,?,?,?)";
